...
class TestShapeFeatures(unittest.TestCase):
    def setUp(self):
        ...
        feature_names = ['area', 'aspect_ratio', 'minx', 'miny', 'maxx', 'maxy', 'density', 'open_0.5_shape', 'perimeter', 'radius', 'raster', 'moment', 'span']
    ...
    def test_single_shape_single_feature(self):
        ...
        self.assertTrue("cell_boundaries_area" in self.data.shapes["cell_boundaries"].columns)
    ...
    def test_single_shape_multiple_features(self):
        ...
        # Check points attrs
        self.assertTrue("transform" in self.data.points["cell_boundaries_raster"].attrs.keys())
        self.assertTrue(self.data.points["cell_boundaries_raster"].attrs["spatialdata_attrs"]["feature_key"] == "feature_name")
        self.assertTrue(self.data.points["cell_boundaries_raster"].attrs["spatialdata_attrs"]["instance_key"] == "cell_boundaries")
    ...
    def test_multiple_shapes_single_feature(self):
        ...
        self.assertTrue("cell_boundaries_area" in self.data.shapes["cell_boundaries"].columns)
        self.assertTrue("nucleus_boundaries_area" in self.data.shapes["nucleus_boundaries"].columns)
    ...
    def test_multiple_shapes_multiple_features(self):
        ...
        # Check points attrs
        self.assertTrue("transform" in self.data.points["nucleus_boundaries_raster"].attrs.keys())
        self.assertTrue(self.data.points["nucleus_boundaries_raster"].attrs["spatialdata_attrs"]["feature_key"] == "feature_name")
        self.assertTrue(self.data.points["nucleus_boundaries_raster"].attrs["spatialdata_attrs"]["instance_key"] == "cell_boundaries")
    ...
    def test_obs_stats(self):
        ...
        # Check if cell_boundaries and nucleus_boundaries shape features are calculated
        self.assertTrue("cell_boundaries_area" in self.data.shapes["cell_boundaries"].columns)
        self.assertTrue("cell_boundaries_aspect_ratio" in self.data.shapes["cell_boundaries"].columns)
        self.assertTrue("cell_boundaries_density" in self.data.shapes["cell_boundaries"].columns)
        self.assertTrue("nucleus_boundaries_area" in self.data.shapes["nucleus_boundaries"].columns)
        self.assertTrue("nucleus_boundaries_aspect_ratio" in self.data.shapes["nucleus_boundaries"].columns)
        self.assertTrue("nucleus_boundaries_density" in self.data.shapes["nucleus_boundaries"].columns)
